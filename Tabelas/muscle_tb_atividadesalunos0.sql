...
--
-- Table structure for table `tb_atividadesalunos`
--

DROP TABLE IF EXISTS `tb_atividadesalunos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_atividadesalunos` (
  `IdAtividadeAluno` int(11) NOT NULL AUTO_INCREMENT,
  `IdAtividade` int(11) NOT NULL,
  PRIMARY KEY (`IdAtividadeAluno`),
  KEY `IdAtividade` (`IdAtividade`),
  CONSTRAINT `tb_atividadesalunos_ibfk_1` FOREIGN KEY (`IdAtividade`) REFERENCES `tb_atividades` (`IdAtividade`)
